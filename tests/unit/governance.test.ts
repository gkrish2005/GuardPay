import { prisma, razorpay, requestConsent, confirmConsent, createTransactionRequest, requestPayment } from "../../src/gateway.js";
...
async function runGovernanceTests() {
  ...
  // 0. Clean up old test data to ensure clean slate
  ...
  if (resF2.verdict !== "BLOCK" || ordersCreateCallCount !== 1) {
